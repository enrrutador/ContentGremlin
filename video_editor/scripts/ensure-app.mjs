...
if (existsSync(join(routesDir, "projects.js"))) {
  console.log("[ensure-app] modular routes present — skip");
  process.exit(0);
}
...
if (!existsSync(payloadDir)) {
  console.error("[ensure-app] no modular src and no payload/");
  process.exit(1);
}
...
console.log("[ensure-app] legacy: wrote src/app.js from payload", code.length);
